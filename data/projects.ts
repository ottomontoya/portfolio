...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    summary: "Delivered two connected tracks — scheduled revenue reporting and interactive workflow apps — to automate manual processes and improve data quality.",
  ...
  },
  {
    ...
    industry: "SaaS",
    role: "BI Consultant",
    summary: "Standardized a fragmented Salesforce reporting landscape by unifying five separate time grains in one flexible QuickSight dashboard set.",
  ...
  },
  {
    ...
    scope: "Implementation",
    timeline: "3 wk",
    evidence: { kind: "units", units: 2000, label: "Assets monitored", mark: "dot", qualifier: "minimum" },
    ...
    images: [
      {
        ...
        width: 1920,
        height: 1018,
        alt: "Furnace process overview dashboard with feed, temperature, heat duty, gas composition, coil readings, and operating-limit status.",
      },
      {
        ...
        width: 1920,
        height: 1019,
        alt: "Detailed furnace metrics dashboard showing firebox readings, stack temperatures, inlet pressures, burner status, draft profile, and fuel composition.",
      },
      {
        ...
        width: 1920,
        height: 1540,
        alt: "Asset deep-dive dashboard with machine status, pressure trends, vital signs, diagnostic alerts, contributing factors, and work-order history.",
      },
      {
        ...
        width: 1920,
        height: 1015,
        alt: "Rotating-equipment fleet dashboard listing pump health scores, operating status, critical alerts, vibration scores, and selected-pair details.",
      },
    ],
  },
];
